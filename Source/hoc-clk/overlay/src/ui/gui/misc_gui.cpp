...
void MiscGui::listUI() {
    ...
    this->listElement->addItem(new CompactCategoryHeader("설정   \uE150 파란색 옵션은 재부팅 없이 적용됩니다"));
...
class ExperimentalSettingsSubMenuGui : public MiscGui {
    ...
    void listUI() override {
        ...
        addConfigButton(KipConfigValue_marikoGpuBootVolt, "GPU 부트 전압", ValueRange(700, 800, 5, "mV", 1), "GPU 부트 전압", &thresholdsDisabled,
                        {}, {}, false, true);
        ...
        addConfigButton(HocClkConfigValue_InputCurrentLimit, "입력 전류 강제 제한 설정", ValueRange(0, 0, 1, "", 0),
                        "입력 전류 강제 제한 설정", &inputLimitThresholds, {}, inputCurrentLimits, false);
...
class CpuSubmenuGui : public MiscGui {
    ...
    void listUI() override {
        ...
        if (IsMariko()) {
            ...
            addConfigToggle(HocClkConfigValue_AutoRAMCPUOverclock, "RAM 연동 CPU 자동 오버클럭");
            addConfigButton(HocClkConfigValue_AutoRamCpuCpuOCFreq, "자동 오버클럭 CPU 클럭", ValueRange(0, 0, 1, "", 1), "CPU 클럭",
                            &thresholdsDisabled, {}, ClkOptionsRamOc, false, false);
            addConfigButton(HocClkConfigValue_AutoRamCpuRamOCThreshold, "자동 오버클럭 RAM 임계값", ValueRange(0, 0, 1, "", 1), "RAM 클럭",
